            ...
            >
                ...
                <div className="relative z-10 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-[11px] text-white/60 leading-none mt-0.5 font-medium">
                ...
                <div className="relative z-10 space-y-6 max-w-md">
                    ...
                    <div className="border-l-2 border-white/30 pl-4">
                        <p className="text-[15px] font-medium leading-relaxed text-white/90">
                            &ldquo;{siteConfig.appName} has completely transformed how I manage my classes. So easy to use — up and running in minutes!&rdquo;
                        </p>
