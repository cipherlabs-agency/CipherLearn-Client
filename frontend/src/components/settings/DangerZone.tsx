...
export function DangerZone() {
    ...
    const { data: draftBatches = [] } = useGetDraftBatchesQuery()
            ...
            <div className="rounded-lg border border-red-500/20 overflow-hidden">
                ...
                <div className="px-4 divide-y divide-border">
                    ...
                    <DangerAction
                        ...
                        description="Permanently remove all soft-deleted students and their attendance records from the database."
