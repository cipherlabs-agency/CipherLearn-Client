...
import { MaintenanceValidations } from "./validation";
...
router.post("/auth", validate(MaintenanceValidations.authenticate), controller.authenticate.bind(controller));
router.get("/status", controller.getStatus.bind(controller));
router.get("/seed-data", controller.getSeedData.bind(controller));
router.post("/seed", validate(MaintenanceValidations.seed), controller.seed.bind(controller));
...
router.post("/test-notification", validate(MaintenanceValidations.testNotification), controller.testNotification.bind(controller));
router.post("/purge-notifications", controller.purgeNotifications.bind(controller));
